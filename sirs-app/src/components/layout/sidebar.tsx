...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: '/rl3/rawat-inap', label: 'Rekapitulasi Pelayanan Rawat Daruat (RL 3.2)', icon: <BedDouble className="w-3.5 h-3.5" /> },
  ...
  },
  {
    ...
    children: [
      ...
      { href: '/rl5/sepuluh-besar-kunjungan-rj', label: '10 Besar Kunjungan Penyakit Rawat Jalan (RL 5.3)', icon: <Trophy className="w-3.5 h-3.5" /> },
    ],
  },
  { section: 'MANAJEMEN' },
  {

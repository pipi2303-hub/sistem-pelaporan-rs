...
const ROWS = [
  ...
  { no: 2,  icd: 'J06.9', diagnosis: 'Acute upper respiratory infection, unspecified', kasusL: 680,  kasusP: 720,  kunjL: 720,   kunjP: 760   },
  { no: 3,  icd: 'E11.9', diagnosis: 'Type 2 diabetes mellitus without complications', kasusL: 620,  kasusP: 750,  kunjL: 1850,  kunjP: 2180  },
  { no: 4,  icd: 'K29.7', diagnosis: 'Gastritis, unspecified',                         kasusL: 480,  kasusP: 560,  kunjL: 680,   kunjP: 790   },
  { no: 5,  icd: 'M54.5', diagnosis: 'Low back pain',                                  kasusL: 420,  kasusP: 510,  kunjL: 895,   kunjP: 1050  },
  { no: 6,  icd: 'J45.9', diagnosis: 'Asthma, unspecified',                            kasusL: 385,  kasusP: 340,  kunjL: 820,   kunjP: 740   },
  { no: 7,  icd: 'A01.0', diagnosis: 'Typhoid fever',                                  kasusL: 310,  kasusP: 285,  kunjL: 345,   kunjP: 318   },
  { no: 8,  icd: 'L30.9', diagnosis: 'Dermatitis, unspecified',                        kasusL: 265,  kasusP: 298,  kunjL: 385,   kunjP: 420   },
  { no: 9,  icd: 'N39.0', diagnosis: 'Urinary tract infection, site not specified',    kasusL: 120,  kasusP: 420,  kunjL: 145,   kunjP: 580   },
  { no: 10, icd: 'H10.9', diagnosis: 'Conjunctivitis, unspecified',                    kasusL: 195,  kasusP: 210,  kunjL: 218,   kunjP: 235   },
]

export default function SepuluhBesarRJPage() {
  return (
    <div className="space-y-5">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900">10 Besar Kasus Baru Penyakit Rawat Jalan (RL 5.2)</h1>
            <p className="text-sm text-slate-500">Sepuluh besar kelompok diagnosis kasus baru rawat jalan — {infoRS.periodeAktif}</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <a href="/reports/RL5.2.pdf" download className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-300 text-slate-600 rounded-lg text-sm font-semibold hover:bg-slate-50 transition-all shadow-sm">

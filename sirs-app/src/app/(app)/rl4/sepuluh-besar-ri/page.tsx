...
const ROWS = [
  { no: 1,  icd: 'I10',    diagnosis: 'Essential (primary) hypertension',          hidupL: 850, hidupP: 920, matiL: 12, matiP: 8  },
  { no: 2,  icd: 'E11.9',  diagnosis: 'Type 2 diabetes mellitus without complications', hidupL: 620, hidupP: 710, matiL: 8,  matiP: 10 },
  { no: 3,  icd: 'J18.9',  diagnosis: 'Pneumonia, unspecified organism',            hidupL: 480, hidupP: 395, matiL: 15, matiP: 12 },
  { no: 4,  icd: 'I21.9',  diagnosis: 'Acute myocardial infarction, unspecified',   hidupL: 385, hidupP: 210, matiL: 42, matiP: 18 },
  { no: 5,  icd: 'N18.5',  diagnosis: 'Chronic kidney disease, stage 5',            hidupL: 310, hidupP: 265, matiL: 28, matiP: 20 },
  { no: 6,  icd: 'A01.0',  diagnosis: 'Typhoid fever',                              hidupL: 285, hidupP: 320, matiL: 2,  matiP: 1  },
  { no: 7,  icd: 'I63.9',  diagnosis: 'Cerebral infarction, unspecified',           hidupL: 245, hidupP: 198, matiL: 22, matiP: 15 },
  { no: 8,  icd: 'K35.8',  diagnosis: 'Acute appendicitis',                         hidupL: 220, hidupP: 195, matiL: 1,  matiP: 0  },
  { no: 9,  icd: 'A15.0',  diagnosis: 'Tuberculosis of lung',                       hidupL: 198, hidupP: 145, matiL: 18, matiP: 10 },
  { no: 10, icd: 'C34.1',  diagnosis: 'Malignant neoplasm of upper lobe, bronchus or lung', hidupL: 175, hidupP: 130, matiL: 32, matiP: 22 },
]

export default function SepuluhBesarRIPage() {
  return (
    <div className="space-y-5">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900">10 Besar Penyakit Rawat Inap (RL 4.2)</h1>
            <p className="text-sm text-slate-500">Sepuluh besar kelompok diagnosis penyakit rawat inap — {infoRS.periodeAktif}</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <a href="/reports/RL4.2.pdf" download className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-300 text-slate-600 rounded-lg text-sm font-semibold hover:bg-slate-50 transition-all shadow-sm">
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              {ROWS.map((row, i) => (
                <tr key={row.no} className="hover:bg-amber-50/20 transition-colors">
